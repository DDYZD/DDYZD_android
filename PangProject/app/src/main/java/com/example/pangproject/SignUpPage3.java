...
public class SignUpPage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView code1 = (TextView) findViewById(R.id.code1); // 코드 말
        final EditText check1 = (EditText) findViewById(R.id.check1); // 코드 입력 부분
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String b = check1.getText().toString();
                int c =0;
                if (a.equals(b)){
                    //Toast.makeText(getApplicationContext(), "성공", Toast.LENGTH_LONG).show();
                    c = 1;
                }
                if (check.getText().length() == 0 || c==0) {
                    AlertDialog.Builder oh = new AlertDialog.Builder(SignUpPage3.this);
